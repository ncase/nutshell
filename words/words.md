...
(You can also download & re-host the files yourself {[full](https://cdn.jsdelivr.net/gh/ncase/nutshell@1.0.1/nutshell.js), [minified](https://cdn.jsdelivr.net/gh/ncase/nutshell@1.0.1/nutshell.min.js)}. Also, Nutshell doesn't require a package manager; I copy-pasted all dependencies into it. Like a *savage*.)
