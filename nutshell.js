...

{
    ...
    Nutshell.options = {
        ...
        //showOnHover: false, // Should bubbles be expanded on hover, instead of click? (default: no) // TODO: click only on mobile?
    ...
    Nutshell.language = {
        en: {
            ...
            // TODO: Undo styling of link inside <b>
    ...
    let _isWikipedia = (url)=>{
        return url.indexOf('wikipedia.org')>=0; // TODO: Simple Wiki, too?
    };
    ...
    Nutshell.createBubble = (expandable, clickX)=>{
        ...
        **************************/
        ...
        // Place the bubble after Expandable. TODO: AFTER PUNCTUATION
    ...
    ***************************************************/
    ...
    .nutshell-ball-up, .nutshell-ball-down{
        ...
        /* TODO: try emoji ·? so same color as font */
    ...
    ***************************************************/
    ...
    /* TODO: MAKE THE BUBBLE SUBTLY MOVE UP & DOWN TOO, ON TOP OF OPEN/CLOSE */
    ...
    /* Arrow white */
    /* TODO: figure out parent page's calculated background? */
    ...
    ***************************************************/
    ...
    /* TODO: Bubble, scroller-container, close
